...
<!-- Contenedor del loader (se muestra sobre la página) -->
<div id="loading-overlay">
    <div id="loading">
        <img src="<?= base_url('public/assets/img/sistema/cargando.gif') ?>" alt="Cargando...">
    </div>
</div>

<!-- CSS para el efecto de superposición -->
<style>
    ...
    /* Centrar el gif y ajustar tamaño */
    #loading {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    #loading img {
        ...
        /*max-width: 150px;*/
        /* Tamaño máximo para evitar que sea muy grande en pantallas grandes */
    }
</style>